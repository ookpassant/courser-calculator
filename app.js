...
(function () {
  ...
  const CHANGELOG = [
    { date: '15 Sep 2026', items: [
      'Group horses are in. All 44 from Tower\'s directory now show up in the Foal Generator parent pickers, in Smart Search and in Recipe, with the Juicy Berry or Juicy Apple each one costs counted in the price.',
